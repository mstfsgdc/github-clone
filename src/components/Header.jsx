    ...
    return (
        <header className="h-[3.75rem] bg-[#161B22] px-[1.5rem] py-[1rem] flex items-center justify-between">
            <div className="left-panel flex items-center">
                <FontAwesomeIcon icon={faGithub} color={'#FFFFFFB3'} size={'2x'} />
                ...
                <a className='font-[600] text-[#f0f6fc] ml-4 whitespace-nowrap text-[0.875rem]'>Pulls</a>
                <a className='font-[600] text-[#f0f6fc] ml-4 whitespace-nowrap text-[0.875rem]'>Issues</a>
                <a className='font-[600] text-[#f0f6fc] ml-4 whitespace-nowrap text-[0.875rem]'>Marketplace</a>
                <a className='font-[600] text-[#f0f6fc] ml-4 whitespace-nowrap text-[0.875rem]'>Explore</a>
            </div>
            <div className="right-panel">
                <FontAwesomeIcon icon={faBell} color={'#f0f6fc'} />
                <FontAwesomeIcon icon={faPlus} color={'#f0f6fc'} className='ml-4' />
            </div>
        </header>
    )
}
